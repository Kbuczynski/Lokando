 ...
 * @property int $type 0-usluga, 1-product, 2-delivery
 * @property float $rating
 * @property int $rating_amount
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Product whereRatingAmount($value)
